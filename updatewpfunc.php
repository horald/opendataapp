...
function abfrageupdate() {
  echo "<form class='form-horizontal' method='post' action='updatewp.php?updatewp=1'>";
  echo "ACHTUNG! Datensicherung anlegen! Die Datenbank wird jetzt aktualisiert.<br>";
  echo "Einige Tabellen werden neu erzeugt. Die alten werden daf&uumlr umbenannt.<br>";
  echo "Datenbank-Update jetzt durchf&uumlhren?<br>";
