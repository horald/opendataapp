...
function insertinput($pararray,$listarray,$filterarray,$filter,$idwert,$menu,$iddetail,$menuid,$krit,$gdbtyp) {
...
//        $defline = mysql_fetch_array($defresult);
        $defresult = db_query($defquery,"",$gdbtyp);
        $defline = db_fetch($defresult,$gdbtyp);
...
function insertsave($pararray,$listarray,$filterarray,$filter,$idwert,$menu,$iddetail,$gdbtyp) {
...
//        $lstinsid=mysql_insert_id();      	
        db_query($lstqry,"",$gdbtyp);
        $lstinsid=db_insert_id($gdbtyp);      	
